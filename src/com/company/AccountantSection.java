...
public class AccountantSection extends JFrame {
	...
	public AccountantSection() {
		...
		JButton btnAddFee = new JButton("Add Fee");
		btnAddFee.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AddFee.main(new String[]{});
				frame.dispose();
			}
		});
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGroup(gl_contentPane.createSequentialGroup()
									.addGap(144)
									.addComponent(btnAddFee, GroupLayout.PREFERRED_SIZE, 133, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(144)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(36)
					.addComponent(btnAddFee, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
					.addGap(36)
